...
import no.acntech.shipment.consumer.ShipmentRestConsumer;
...
public class OrderOrchestrationService {
    ...
    private final InvoiceRestConsumer invoiceRestConsumer;
    private final ShipmentRestConsumer shipmentRestConsumer;
    ...
    public OrderOrchestrationService(final ConversionService conversionService,
                                     ...
                                     final InvoiceRestConsumer invoiceRestConsumer,
                                     final ShipmentRestConsumer shipmentRestConsumer) {
        this.conversionService = conversionService;
        this.orderService = orderService;
        this.reservationRestConsumer = reservationRestConsumer;
        this.invoiceRestConsumer = invoiceRestConsumer;
        this.shipmentRestConsumer = shipmentRestConsumer;
    }
    ...
    public OrderDto updateOrderItem(@NotNull final UUID itemId,
        ...
        if (orderDto.areAllItemsConfirmed()) {
            ...
            invoiceRestConsumer.create(createInvoiceDto);
            ...
            shipmentRestConsumer.create(createShipmentDto);
