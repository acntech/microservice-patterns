...
public class InvoiceService {
    ...
    @Transactional
    public void createInvoice(@NotNull @Valid final CreateInvoiceDto createInvoiceDto) {
        ...
        LOGGER.debug("Created invoice for order with order-id {}", createInvoiceDto.getOrderId());
    }
