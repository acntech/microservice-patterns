...
import static no.acntech.common.config.KafkaTopic.INVENTORY;
...
public class TestData {
    ...
    public TestData(final KafkaTemplate<String, Object> kafkaTemplate) {
    ...
    private void insertTestdata() {
        ...
        PRODUCT_NAMES.stream()
                .map(name -> Product.builder()
                        ...
                        .price(randomPrice())
                        .build())
                .forEach(product -> kafkaTemplate.send(INVENTORY.getName(), product));
