...
* Rollback can be hard and compensating transactions might be needed. What happens if shipment failed after warehouse reservationEntity has been confirmed?
